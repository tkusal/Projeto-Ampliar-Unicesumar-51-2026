...
int main() {
    ...
    for (i = 1; i <= 10; i++) {
        printf("Eleitor %d - Digite seu voto (1-5): ", i);
        scanf("%d", &voto);
        ...
        if (voto == 1) {
            ...
            i--; // repete o voto do mesmo eleitor
        }
    }

    // Resultado
    printf("\nResultado da Eleicao:\n");
    printf("Chapa Alfa: %d votos\n", alfa);
    printf("Chapa Beta: %d votos\n", beta);
    printf("Chapa Omega: %d votos\n", omega);
...
//Professor, desenvolvi o algoritmo em linguagem C utilizando estrutura de repetição para coletar os votos de 10 eleitores e estruturas condicionais para validar as entradas e contabilizar os votos para cada opção. O programa também trata votos inválidos e, ao final, apresenta o relatório completo com a quantidade de votos e identifica a chapa vencedora.